    ...
    public class WorldContextSeed
    {
        ...
        public async Task Seed ( )
        {
            ...
            if ( !_context . Trips . Any ( ) )
            {
                ...
                await _context . Trips . AddAsync ( usTrip );
                await _context . Stops . AddRangeAsync ( usTrip . Stops );
                ...
                await _context . Trips . AddAsync ( worldTrip );
                await _context . Stops . AddRangeAsync ( worldTrip . Stops );
